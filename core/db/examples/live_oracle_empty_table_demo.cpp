...
//       -I <BOOST_ROOT> examples/live_oracle_empty_table_demo.cpp \
//       -L <INSTANT_CLIENT> -lclntsh -o live_oracle_empty_table_demo
//   LD_LIBRARY_PATH=<INSTANT_CLIENT> ./live_oracle_empty_table_demo <connect_string> <user> <password>
#include <cstdio>
